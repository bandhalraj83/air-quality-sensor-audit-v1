...
def run(raw_dir: Path = None, interim_dir: Path = None, reports_dir: Path = None, city: str = None):
    ...
    def _worldpop():
        ...
        # Saved as GeoTIFF, not a bare .npy -- Stage 2 needs the transform
        # and CRS to reproject/resample/clip this against the other layers.
        out_path = interim_dir / "worldpop_validated.tif"
        with rasterio.open(
            out_path, "w", driver="GTiff",
            height=cleaned.shape[0], width=cleaned.shape[1],
